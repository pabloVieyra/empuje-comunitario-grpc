...
const SaveEventFilterModal = ({ filters, onClose, onSave }) => {
    ...
    >
      <Card style={{
        ...
        <Flex gap={4} justify="center">
          <Btn onClick={() => { onSave(name, filters); onClose(); }} style={{ background: "#2456e9", color: "#fff", fontWeight: 600 }}>
            Guardar
          </Btn>
...
export default SaveEventFilterModal;